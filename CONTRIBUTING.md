How to Submit Patches to the Rental Calc Project
===============================================================================
https://github.com/brarcher/budget-watch

This document is intended to act as a guide to help you contribute to the
Rental Calc project.  It is not perfect, and there will always be exceptions
...
The Rental Calc code uses a fair number of unit tests to verify that
...
and potentially merged into the main Rental Calc repository. The preferred
way to do this is to submit a Pull Request to the Rental Calc project.
